...
public class Launcher {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Configuration pluginConfig = parent.configuration().resolveAndBind(ModuleFinder.of(libraryModules.toArray(Path[]::new)), ModuleFinder.of(), Collections.singleton("de.nocoffeetech.webservices"));
        ...
        MethodHandle handle;
        try {
            Class<?> loaderClass = pluginLayer.findLoader("de.nocoffeetech.webservices").loadClass("de.nocoffeetech.webservices.internal.loader.Loader");
